...
public class SemanticKernelChatCompletionsWithDataStreamingClass
{
    public SemanticKernelChatCompletionsWithDataStreamingClass(string systemPrompt, Kernel kernel)
    {
